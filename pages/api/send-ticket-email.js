...
export default async function handler(req, res) {
  ...
  if (req.method === 'POST') {
    ...
    const { email, orderId, eventDetails, tickets, totalAmount, transactionFee, discount, discountDescription } = req.body;
